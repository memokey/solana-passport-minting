...
export declare const cache: {
    ...
    query: (connection: Connection, pubKey: string | PublicKey, parser?: AccountParser) => Promise<ParsedAccountBase>;
    add: (id: PublicKey | string, obj: AccountInfo<Buffer>, parser?: AccountParser, isActive?: boolean | ((parsed: any) => boolean) | undefined) => ParsedAccountBase | undefined;
