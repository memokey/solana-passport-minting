...
export declare const pullPacks: (connection: Connection, state: MetaState, walletKey?: PublicKey | null) => Promise<MetaState>;
...
export declare const pullPage: (connection: Connection, page: number, tempCache: MetaState, walletKey?: PublicKey | null, shouldFetchNftPacks?: boolean) => Promise<MetaState>;
